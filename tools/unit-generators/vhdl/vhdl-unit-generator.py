...
if __name__ == "__main__":
    ...
    generators.add("handshake", "queue")
    ...
    # arith on raw wires: the logic between an unbundle and a bundle
    generators.add("arith", "arith_addi")
    generators.add("arith", "arith_andi")
    generators.add("arith", "arith_cmpi")
    generators.add("arith", "arith_constant")
    generators.add("arith", "arith_extsi")
    generators.add("arith", "arith_extui")
    generators.add("arith", "arith_muli")
    generators.add("arith", "arith_ori")
    generators.add("arith", "arith_select")
    generators.add("arith", "arith_shli")
    generators.add("arith", "arith_shrsi")
    generators.add("arith", "arith_shrui")
    generators.add("arith", "arith_subi")
    generators.add("arith", "arith_trunci")
    generators.add("arith", "arith_xori")
