...
#include "dynamatic/Dialect/HW/CustomDirectiveImpl.h"
#include "dynamatic/Dialect/HW/HWAttributes.h"
#include "dynamatic/Dialect/HW/HWInstanceImplementation.h"
#include "dynamatic/Dialect/HW/HWSymCache.h"
#include "dynamatic/Dialect/HW/ModuleImplementation.h"
...
FunctionType hw::getModuleType(Operation *moduleOrInstance) {
  return llvm::TypeSwitch<Operation *, FunctionType>(moduleOrInstance)
...
#include "dynamatic/Dialect/HW/HW.cpp.inc"
